...
public class ObjectDetector {
    ...
    private  int width=0;
    private String[] finalClasses = { "person", "dog", "cat", "bike","motorcycle","car", "boat","train", "truck","bus","fire hydrant","traffic light", "stop light", "bird", "chair", "couch", "bed", "potted plants", "sports ball", "toilet", "vase" };
